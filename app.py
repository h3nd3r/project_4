...
from agents.implementation_agent import HtmlAgent
...
async def on_message(message: cl.Message):
    ...
    response_message = await html_agent.execute(message_history)
    message_history.append({"role": "assistant", "content": response_message})
    cl.user_session.set("message_history", message_history)
...
html_agent = HtmlAgent(name="Html Agent", client=client)
